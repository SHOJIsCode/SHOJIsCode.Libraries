...
namespace SHOJIsCode.Libraries {
    ...
    public struct FormattableBoolean : IFormattable {
        ...
        #region キャスト
        /// <summary>
        /// FormattableBoolean型からBoolean型へのキャスト
        /// </summary>
        /// <param name="value">FormttableBoolean型</param>
        /// <returns>キャストされたBoolean型</returns>
        public static implicit operator bool(FormattableBoolean value) { return value.b; }

        /// <summary>
        /// Boolean型からFormattableBoolean型へのキャスト
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
